...
#define VERSION		"2013_05_04"
#define M2HVERSION	"2013_12_28"
...
#define CELL_LIST	1
#define	MAXNCELLSITES	3000		// max atom # in each cell 
...
#define MAXNMOLS	36		// max # of molecules in ALL boxes
#define MAXNMOLSITES	1001		// max # of sites on one single chain molecule
#define MAXNATOMS	10000
